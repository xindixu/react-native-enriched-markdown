...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownMarkdownStyleSpoilerParticlesStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownMarkdownStyleSpoilerSolidStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
struct EnrichedMarkdownMarkdownStyleMentionStruct {
  SharedColor color{};
  SharedColor backgroundColor{};
  SharedColor borderColor{};
  Float borderWidth{0.0};
  ...
  std::string fontWeight{};
  Float fontSize{0.0};
  Float pressedOpacity{0.0};

#ifdef RN_SERIALIZABLE_STATE
  bool operator==(const EnrichedMarkdownMarkdownStyleMentionStruct &) const = default;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownMarkdownStyleMentionStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
  ...
  auto tmp_pressedOpacity = map.find("pressedOpacity");
  if (tmp_pressedOpacity != map.end()) {
    fromRawValue(context, tmp_pressedOpacity->second, result.pressedOpacity);
  }
}

static inline std::string toString(const EnrichedMarkdownMarkdownStyleMentionStruct &value) {
  return "[Object EnrichedMarkdownMarkdownStyleMentionStruct]";
}

#ifdef RN_SERIALIZABLE_STATE
static inline folly::dynamic toDynamic(const EnrichedMarkdownMarkdownStyleMentionStruct &value) {
  return value.toDynamic();
}
#endif
...
struct EnrichedMarkdownMarkdownStyleCitationStruct {
  SharedColor color{};
  Float fontSizeMultiplier{0.0};
  Float baselineOffsetPx{0.0};
  std::string fontWeight{};
  bool underline{false};
  SharedColor backgroundColor{};
  Float paddingHorizontal{0.0};
  ...
  folly::dynamic toDynamic() const {
    ...
    result["baselineOffsetPx"] = baselineOffsetPx;
    result["fontWeight"] = fontWeight;
    result["underline"] = underline;
    result["backgroundColor"] = ::facebook::react::toDynamic(backgroundColor);
    result["paddingHorizontal"] = paddingHorizontal;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
  ...
  auto tmp_fontSizeMultiplier = map.find("fontSizeMultiplier");
  if (tmp_fontSizeMultiplier != map.end()) {
    fromRawValue(context, tmp_fontSizeMultiplier->second, result.fontSizeMultiplier);
  }
  auto tmp_baselineOffsetPx = map.find("baselineOffsetPx");
  if (tmp_baselineOffsetPx != map.end()) {
    fromRawValue(context, tmp_baselineOffsetPx->second, result.baselineOffsetPx);
  }
  auto tmp_fontWeight = map.find("fontWeight");
  if (tmp_fontWeight != map.end()) {
    fromRawValue(context, tmp_fontWeight->second, result.fontWeight);
...
struct EnrichedMarkdownMarkdownStyleStruct {
  ...
  EnrichedMarkdownMarkdownStyleMentionStruct mention{};
  ...
  folly::dynamic toDynamic() const {
    ...
    result["mention"] = ::facebook::react::toDynamic(mention);
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownTextInputMarkdownStyleStrongStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownTextInputMarkdownStyleEmStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownTextInputMarkdownStyleLinkStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownTextInputMarkdownStyleSpoilerStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownTextInputMarkdownStyleStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownTextInputContextMenuItemsStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                std::vector<EnrichedMarkdownTextInputContextMenuItemsStruct> &result) {
  auto items = (std::vector<RawValue>)value;
  for (const auto &item : items) {
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownTextInputLinkRegexStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
public:
  ...
  EnrichedMarkdownTextInputProps(const PropsParserContext &context, const EnrichedMarkdownTextInputProps &sourceProps,
                                 const RawProps &rawProps);
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownTextMarkdownStyleSpoilerParticlesStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownTextMarkdownStyleSpoilerSolidStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
struct EnrichedMarkdownTextMarkdownStyleMentionStruct {
  SharedColor color{};
  SharedColor backgroundColor{};
  SharedColor borderColor{};
  Float borderWidth{0.0};
...
#ifdef RN_SERIALIZABLE_STATE
  bool operator==(const EnrichedMarkdownTextMarkdownStyleMentionStruct &) const = default;
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
                                EnrichedMarkdownTextMarkdownStyleMentionStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
static inline std::string toString(const EnrichedMarkdownTextMarkdownStyleMentionStruct &value) {
  return "[Object EnrichedMarkdownTextMarkdownStyleMentionStruct]";
}

#ifdef RN_SERIALIZABLE_STATE
static inline folly::dynamic toDynamic(const EnrichedMarkdownTextMarkdownStyleMentionStruct &value) {
  return value.toDynamic();
}
#endif
...
struct EnrichedMarkdownTextMarkdownStyleStruct {
  ...
  EnrichedMarkdownTextMarkdownStyleMentionStruct mention{};
