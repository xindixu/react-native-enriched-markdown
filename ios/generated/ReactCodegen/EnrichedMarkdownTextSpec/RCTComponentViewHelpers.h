...
RCTEnrichedMarkdownTextInputHandleCommand(id<RCTEnrichedMarkdownTextInputViewProtocol> componentView,
                                          NSString const *commandName, NSArray const *args)
{
  if ([commandName isEqualToString:@"focus"]) {
#if RCT_DEBUG
    if ([args count] != 0) {
      RCTLogError(@"%@ command %@ received %d arguments, expected %d.", @"EnrichedMarkdownTextInput", commandName,
                  (int)[args count], 0);
      return;
    }
#endif
...
#if RCT_DEBUG
    if (!RCTValidateTypeOfViewCommandArgument(arg0, [NSString class], @"string", @"EnrichedMarkdownTextInput",
                                              commandName, @"1st")) {
      return;
    }
#endif
  ...
  if ([commandName isEqualToString:@"setSelection"]) {
    ...
    NSObject *arg0 = args[0];
#if RCT_DEBUG
    if (!RCTValidateTypeOfViewCommandArgument(arg0, [NSNumber class], @"number", @"EnrichedMarkdownTextInput",
                                              commandName, @"1st")) {
      return;
    }
#endif
...
#if RCT_DEBUG
    if (!RCTValidateTypeOfViewCommandArgument(arg1, [NSNumber class], @"number", @"EnrichedMarkdownTextInput",
                                              commandName, @"2nd")) {
      return;
    }
#endif
  ...
  if ([commandName isEqualToString:@"insertLink"]) {
    ...
    NSObject *arg1 = args[1];
#if RCT_DEBUG
    if (!RCTValidateTypeOfViewCommandArgument(arg1, [NSString class], @"string", @"EnrichedMarkdownTextInput",
                                              commandName, @"2nd")) {
      return;
    }
#endif
