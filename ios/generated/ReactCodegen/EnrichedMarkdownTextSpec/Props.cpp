...
EnrichedMarkdownProps::EnrichedMarkdownProps(const PropsParserContext &context,
    ...
    : ViewProps(context, sourceProps, rawProps),
      ...
      selectionHandleColor(
          convertRawProp(context, rawProps, "selectionHandleColor", sourceProps.selectionHandleColor, {})),
      ...
      spoilerOverlay(
          convertRawProp(context, rawProps, "spoilerOverlay", sourceProps.spoilerOverlay, {std::string{"particles"}})),
...
#endif
EnrichedMarkdownTextInputProps::EnrichedMarkdownTextInputProps(const PropsParserContext &context,
...
folly::dynamic EnrichedMarkdownTextInputProps::getDiffProps(const Props *prevProps) const {
  static const auto defaultProps = EnrichedMarkdownTextInputProps();
  const EnrichedMarkdownTextInputProps *oldProps =
      prevProps == nullptr ? &defaultProps : static_cast<const EnrichedMarkdownTextInputProps *>(prevProps);
  if (this == oldProps) {
    return folly::dynamic::object();
  }
  folly::dynamic result = HostPlatformViewProps::getDiffProps(prevProps);
