...
function citationStyle(style) {
  ...
  const hasBackground = !!citation.backgroundColor && citation.backgroundColor !== 'transparent';
  const hasBorder = !!citation.borderColor && citation.borderColor !== 'transparent' && citation.borderWidth > 0;
  return {
    ...
    borderRadius: hasBackground || hasBorder ? citation.borderRadius : undefined,
    cursor: 'pointer'
  };
}
