...
static inline void fromRawValue(const PropsParserContext& context, const RawValue &value, EnrichedMarkdownMarkdownStyleMentionStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
...
static inline void fromRawValue(const PropsParserContext& context, const RawValue &value, EnrichedMarkdownTextMarkdownStyleMentionStruct &result) {
  auto map = (std::unordered_map<std::string, RawValue>)value;
